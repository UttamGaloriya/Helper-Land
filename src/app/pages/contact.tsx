...
function Contactpage() {
  ...
  return (
    <>
      ...
      <Navbar></Navbar>
      <div className="contact-banner">{/* banner-image */}</div>
        ...
        <Grid container style={{ maxWidth: "1140px", margin: "0 auto" }}>
          ...
          <Grid item lg={4} md={4} sm={12} xs={12}>
            <div className="detail-1">
              ...
              <p>
                <a href="tel:+4940123567890" title="Call Now">
                  +49 (40) 123 56 7890
                </a>
                <br />
                <a href="tel:+4940123567890" title="Call Now">
      ...
      <form
        ...
        action="https://formspree.io/f/mlekovbg"
        method="POST"
        onSubmit={sendemail}
      >
      ...
      <div className="map">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3671.697915881948!2d72.49786087597927!3d23.03486131586824!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e8352e403437b%3A0xdc9d4dae36889fb9!2sTatvaSoft!5e0!3m2!1sen!2sin!4v1682770137238!5m2!1sen!2sin"
          width="100%"
          height="400"
          loading="lazy"
        ></iframe>
